...
function switchFish(val){        //contains the individual fish images
  ...
  switch (val){
    case 0:                   //INFORMATION card
      outputEl.html("<img src='../img/placeholder/cards/CardInfo.png' id='fishes'/>");
      console.log("Image 0");
      break;
    case 1:                   //CATFISH
      outputEl.html("<img src='../img/placeholder/cards/card1.png' id='fishes'/>");
      console.log("Image 1");
      break;
    case 2:                   //OARFISH
